const fs = require('fs');
const spec = JSON.parse(fs.readFileSync('videos/phan-53-2026-09-17-khi-dang-buc-tra-loi-sau-tot-hon/spec.json', 'utf8'));
...
console.log('✅ Spec verification passed completely! Total scenes:', spec.scenes.length, 'Total frames:', spec.totalFrames);
