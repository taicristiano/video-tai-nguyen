const fs = require('fs');
const spec = JSON.parse(fs.readFileSync('videos/phan-54-2026-09-17-hoc-xong-mot-khoa-truoc-khi-mo-khoa-moi/spec.json', 'utf8'));
...
console.log('✅ Spec verification passed completely for phan-54! Total scenes:', spec.scenes.length, 'Total frames:', spec.totalFrames);
