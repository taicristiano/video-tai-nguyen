# HAY & ĐẸP. V3.6 Generalization Evaluation — VIDEO005

**Profile:** `relationship-dialogue`  
**Video Title:** Mười Phút Reset Cuối Ngày Đáng Giá Hơn Một Giờ Dọn Cuối Tuần  
**Slug:** `phan-5-2026-09-17-muoi-phut-reset-cuoi-ngay-dang-gia-hon`  
**Test Span:** First 6 scenes, 550 frames (~18.3s @ 30fps)  
...
- Visual QA state: `PASS` (Awaiting human visual QA).
...
- Voiceover source loaded from `public/phan-5-2026-09-17-muoi-phut-reset-cuoi-ngay-dang-gia-hon/voice.mp3`.
...
- Timing strictly driven by speech boundaries in `spec.json` (total 550 frames).
...
- Visual motifs directly reflect narrative intent for the `relationship-dialogue` profile.
