# HAY & ĐẸP. V3.6 Generalization Evaluation — VIDEO028

**Profile:** `family-emotional`  
**Video Title:** Không Cần Trả Lời Mọi Thông Báo  
**Slug:** `phan-28-2026-09-17-khong-can-tra-loi-moi-thong-bao-ngay`  
**Test Span:** First 6 scenes, 444 frames (~14.8s @ 30fps)  
...
- Voiceover source loaded from `public/phan-28-2026-09-17-khong-can-tra-loi-moi-thong-bao-ngay/voice.mp3`.
...
- Timing strictly driven by speech boundaries in `spec.json` (total 444 frames).
