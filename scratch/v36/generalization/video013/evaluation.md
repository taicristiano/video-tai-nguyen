# HAY & ĐẸP. V3.6 Generalization Evaluation — VIDEO013

**Profile:** `books-ideas`  
**Video Title:** Không Phải Lúc Nào Người Khác Kể Chuyện Cũng Cần Sửa Giúp  
**Slug:** `phan-13-2026-09-17-khong-phai-luc-nao-nguoi-khac-ke-chuyen`  
**Test Span:** First 6 scenes, 645 frames (~21.5s @ 30fps)  
...
- Voiceover source loaded from `public/phan-13-2026-09-17-khong-phai-luc-nao-nguoi-khac-ke-chuyen/voice.mp3`.
...
- Timing strictly driven by speech boundaries in `spec.json` (total 645 frames).
...
- Visual motifs directly reflect narrative intent for the `books-ideas` profile.
