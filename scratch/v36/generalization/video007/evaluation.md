# HAY & ĐẸP. V3.6 Generalization Evaluation — VIDEO007

**Profile:** `home-living`  
**Video Title:** Hai Mươi Bốn Giờ Trước Một Món Mua Không Cần Gấp  
**Slug:** `phan-7-2026-09-17-hai-muoi-bon-gio-truoc-mot-mon-mua`  
**Test Span:** First 6 scenes, 525 frames (~17.5s @ 30fps)  
...
- Voiceover source loaded from `public/phan-7-2026-09-17-hai-muoi-bon-gio-truoc-mot-mon-mua/voice.mp3`.
...
- Timing strictly driven by speech boundaries in `spec.json` (total 525 frames).
...
- Visual motifs directly reflect narrative intent for the `home-living` profile.
