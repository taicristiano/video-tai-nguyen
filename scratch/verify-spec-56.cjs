const fs = require('fs');
const spec = JSON.parse(fs.readFileSync('videos/phan-56-2026-09-17-mot-khoang-yen-khong-can-muc-dich/spec.json', 'utf8'));
...
console.log('✅ Spec verification passed completely for phan-56! Total scenes:', spec.scenes.length, 'Total frames:', spec.totalFrames);
