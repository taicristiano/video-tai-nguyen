...
> Template dùng cho batch test đầu tiên: `creative/spatial-flow-sfx`  
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, phong cách dark cinematic technology editorial, chữ trắng và electric blue.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, dark cinematic, visual dạng transaction flow.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, dark editorial, visual crawler-index-query-ranking.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, business explainer, dark cinematic, money-flow visualization.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, cinematic global network, bản đồ và tuyến cáp biển.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, spatial satellite visualization, dark blue technology style.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, business model flow, dark editorial.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, technical comparison visualization, dark tech.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, map data-flow visualization.
...
```text
/gen-video --template creative/spatial-flow-sfx Video dọc 9:16, khoảng 40–50 giây, geopolitical network map, submarine cables, rerouting.
