...
export type CurrentAffairsDarkSceneType = 'hook' | 'body' | 'ending';

export interface CurrentAffairsDarkScene {
  type: CurrentAffairsDarkSceneType;
  startFrame: number;
...
export interface CurrentAffairsDarkSpec {
  ...
  scenes: CurrentAffairsDarkScene[];
}
