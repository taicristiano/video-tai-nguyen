...
export interface SportsBriefingSceneProps {
  variant:
    | 'opening'
    | 'scoreline'
    | 'playerSpotlight'
...
export interface SportsBriefingLightScene {
  type: 'sportsBriefingLight';
  startFrame: number;
  durationFrames: number;
  audioSegment: AudioSegment;
  sports: SportsBriefingSceneProps;
}

export interface SportsBriefingLightSpec {
  ...
  scenes: SportsBriefingLightScene[];
}
